//create map
const map = L.map("mapid").setView([-8.756544, -63.8899263], 15);
...
function addPhotoField() {
  //tenho de pegar o container de fotos #images
  ...
  //verifar se o campo está vazio, se seim, não adicionar ao container de imagens
